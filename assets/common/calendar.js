...
function tzlib_get_ical_block(e, a = !1) {
    ...
    var n;
    return null == t[1] || "" == t[1] ? "" : (n = "TZID=" + (e = "" == t[0] ? e : t[0]), e = ["BEGIN:VTIMEZONE\r\nTZID:" + e + "\r\nX-LIC-LOCATION:" + e + "\r\nLAST-MODIFIED:" + t[1].replace(/[^\w_\-:,;=+/<br>]/g, "").replace(/<br>/g, "\r\n") + "END:VTIMEZONE", n], a ? JSON.stringify(e) : e)
}
...
function tzlib_get_offset(e, a, t) {
    ...
    let c = 0;
    for (let e = 0; e < r.length; e++) r["" + e].startsWith("TZOFFSETTO") && (c++, s["" + c].offset = r["" + e].split(":")[1]), r["" + e].startsWith("DTSTART") && (s["" + c].hour = parseInt(r["" + e].substr(17, 2))), r["" + e].startsWith("RRULE") && (o = r["" + e].split(";"), i = parseInt(o[1].split("=")[1]), s["" + c].month = parseInt(i), s["" + c].day = o[2].split("=")[1]);
    ...
    var g, t = "-" == s["" + d].day[0] ? (g = s["" + d].day.substr(2, 2), e = Object.keys(p["" + g]).length + 1 - parseInt(s["" + d].day[1]), p["" + g]["" + e]) : (g = s["" + d].day.substr(1, 2), p["" + g][s["" + d].day[0]]);
            ...
            if ("object" != typeof a || Array.isArray(a)) t.push(e);
                ...
                for (var [n, o] of Object.entries(a))
                    if ("object" != typeof o || Array.isArray(o)) t.push(e + "/" + n);
                        ...
                        for (var [i] of Object.entries(o)) t.push(e + "/" + n + "/" + i);
        return t
...
function atcb_decorate_data(e) {
    return (e = atcb_decorate_data_identifier(e)).subscribe = atcb_decorate_data_subscribe(e), (e = atcb_decorate_data_options(e = atcb_decorate_data_rrule(e))).richData = atcb_decorate_data_rich_data(e), e.checkmark = atcb_decorate_data_checkmark(e), e.background = atcb_decorate_data_background(e), e.mindScrolling = atcb_decorate_data_mind_scrolling(e), e.branding = atcb_decorate_data_branding(e), e = atcb_decorate_data_extend(e = atcb_decorate_data_meta(e = atcb_decorate_data_dates(e = atcb_decorate_data_i18n(e = atcb_decorate_data_style(e)))))
}

function atcb_decorate_data_identifier(e) {
    return null != e.identifier && "" != e.identifier && (e.identifier = "atcb-btn-" + e.identifier, /^[\w-]+$/.test(e.identifier) || (e.identifier = "", console.warn("Add to Calendar Button generation: identifier invalid - using auto numbers instead"))), e
}
    ...
    if (null != e.recurrence && "" != e.recurrence)
        if (e.recurrence = e.recurrence.replace(/\s+/g, "").toUpperCase(), /^(RRULE:[\w=;,:+-/\\]+|daily|weekly|monthly|yearly)$/im.test(e.recurrence))
            if (/^RRULE:/i.test(e.recurrence)) {
                ...
                }), e.recurrence_until = t.UNTIL || "", e.recurrence_count = t.COUNT || "", e.recurrence_byDay = t.BYDAY || "", e.recurrence_byMonth = t.BYMONTH || "", e.recurrence_byMonthDay = t.BYMONTHDAY || "", e.recurrence_interval = t.INTERVAL || 1, e.recurrence_frequency = t.FREQ || ""
            } else null != e.recurrence_interval && "" != e.recurrence_interval || (e.recurrence_interval = 1), (null == e.recurrence_weekstart || "" == e.recurrence_weekstart | 2 < e.recurrence_weekstart.length) && (e.recurrence_weekstart = "MO"), e.recurrence_frequency = e.recurrence, e.recurrence = "RRULE:FREQ=" + e.recurrence + ";WKST=" + e.recurrence_weekstart + ";INTERVAL=" + e.recurrence_interval, null != e.recurrence_until && "" != e.recurrence_until && (null != e.endTime && "" != e.endTime ? e.recurrence = e.recurrence + ";UNTIL=" + e.recurrence_until.replace(/-/g, "").slice(0, 8) + "T" + e.endTime.replace(":", "") + "00" : e.recurrence = e.recurrence + ";UNTIL=" + e.recurrence_until.replace(/-/g, "").slice(0, 8)), null != e.recurrence_count && "" != e.recurrence_count && (e.recurrence = e.recurrence + ";COUNT=" + e.recurrence_count), null != e.recurrence_byDay && "" != e.recurrence_byDay && (e.recurrence = e.recurrence + ";BYDAY=" + e.recurrence_byDay), null != e.recurrence_byMonth && "" != e.recurrence_byMonth && (e.recurrence = e.recurrence + ";BYMONTH=" + e.recurrence_byMonth), null != e.recurrence_byMonthDay && "" != e.recurrence_byMonthDay && (e.recurrence = e.recurrence + ";BYMONTHDAY=" + e.recurrence_byMonthDay);
...
function atcb_decorate_data_options(a) {
    ...
    for (let e = 0; e < a.options.length; e++) {
        ...
        var n = i[0].toLowerCase().replace("microsoft", "ms").replace(".", ""),
            o = null != i[1] ? i[1] : "";
        isiOS() && atcbiOSInvalidOptions.includes(n) || null != a.recurrence && "" != a.recurrence && (!atcbValidRecurrOptions.includes(n) || null != a.recurrence_until && "" != a.recurrence_until && ("apple" == n || "ical" == n)) || a.subscribe && atcbInvalidSubscribeOptions.includes(n) || (t.push(n), a.optionLabels.push(o))
    }
...
function atcb_decorate_data_style(e) {
    if (null != e.listStyle && "" != e.listStyle || (e.listStyle = "dropdown"), "modal" === e.listStyle && (e.trigger = "click"), null != e.buttonStyle && "" != e.buttonStyle && "default" != e.buttonStyle ? ("bubble" != e.buttonStyle && "text" != e.buttonStyle && "date" != e.buttonStyle || (e.trigger = "click"), "date" == e.buttonStyle && "dropdown" == e.listStyle && (e.listStyle = "overlay")) : e.buttonStyle = "", e.sizes = [], e.sizes.l = e.sizes.m = e.sizes.s = 16, null != e.size && "" != e.size) {
        var a = e.size.split("|");
        for (let e = 0; e < a.length; e++) a["" + e] = parseInt(a["" + e]);
        0 <= a[0] && a[0] < 11 && (e.sizes.l = 10 + a[0]), 2 < a.length ? (0 <= a[1] && a[1] < 11 && (e.sizes.m = 10 + a[1]), 0 <= a[2] && a[2] < 11 && (e.sizes.s = 10 + a[2])) : 2 == a.length && 0 <= a[1] && a[1] < 11 && (e.sizes.m = e.sizes.s = 10 + a[1])
    }
    ...
    var n;
    return e.iconButton = !0, e.iconList = !0, e.iconModal = !0, null != e.icons && (e.icons = String(e.icons), "" != e.icons && ("false" == (n = e.icons.split("|"))[0] && (e.iconButton = !1), null != n[1] && "false" == n[1] && (e.iconList = !1), null != n[2] && "false" == n[2] && (e.iconModal = !1))), e.textLabelButton = !0, e.textLabelList = !0, null != e.textLabels && (e.textLabels = String(e.textLabels), "" != e.textLabels && ("false" == (n = e.textLabels.split("|"))[0] && (e.textLabelButton = !1), null != n[1] && "false" == n[1] && (e.textLabelList = !1))), e
}
...
function atcb_decorate_data_dates(a) {
    if (null != a.dates && 0 < a.dates.length)
        for (let e = 0; e < a.dates.length; e++) {
            ...
            a.dates["" + e].startTime = t.startTime, a.dates["" + e].endTime = t.endTime, a.dates["" + e].timeZone = t.timeZone, a.dates["" + e].timestamp = t.startTimestamp, a.dates["" + e].startDate = atcb_date_calculation(t.startDate), a.dates["" + e].endDate = atcb_date_calculation(t.endDate)
        } else {
            var e = atcb_date_cleanup(a);
            a.dates = [], a.dates[0] = new Object, a.startTime = a.dates[0].startTime = e.startTime, a.endTime = a.dates[0].endTime = e.endTime, a.timeZone = a.dates[0].timeZone = e.timeZone, a.startDate = a.dates[0].startDate = atcb_date_calculation(e.startDate), a.endDate = a.dates[0].endDate = atcb_date_calculation(e.endDate)
        }
    e = new Date;
...
function atcb_decorate_data_description(e, a) {
    return null != e.dates["" + a].description && "" != e.dates["" + a].description ? (e.dates["" + a].descriptionHtmlFree = atcb_rewrite_html_elements(e.dates["" + a].description, !0), e.dates["" + a].description = atcb_rewrite_html_elements(e.dates["" + a].description)) : null == e.dates["" + a].description && null != e.description && "" != e.description ? (e.dates["" + a].descriptionHtmlFree = atcb_rewrite_html_elements(e.description, !0), e.dates["" + a].description = atcb_rewrite_html_elements(e.description)) : e.dates["" + a].descriptionHtmlFree = e.dates["" + a].description = "", e
}
...
function atcb_date_cleanup(n) {
    ...
    return ["start", "end"].forEach(function (e) {
        var a;
        null != n[e + "Date"] && (n[e + "Date"] = n[e + "Date"].replace(/\.\d{3}/, "").replace("Z", ""), null != (a = n[e + "Date"].split("T"))[1] && (n[e + "Date"] = a[0], n[e + "Time"] = a[1])), null != n[e + "Time"] && 8 === n[e + "Time"].length && (a = n[e + "Time"], n[e + "Time"] = a.substring(0, a.length - 3)), "currentBrowser" == n.timeZone && (n.timeZone = Intl.DateTimeFormat().resolvedOptions().timeZone);
        let t;
    ...
    if (null != t.dates && 0 < t.dates.length) {
        ...
        return ["name", "startDate"].every(function (a) {
            for (let e = 0; e < t.dates.length; e++)
                if (!n.includes("" + a) && (null == t.dates["" + e]["" + a] || "" == t.dates["" + e]["" + a]) || n.includes("" + a) && (null == t.dates["" + e]["" + a] || "" == t.dates["" + e]["" + a]) && (null == t["" + a] || "" == t["" + a])) return console.error("Add to Calendar Button generation failed: required setting missing [dates array object #" + (e + 1) + "/" + t.dates.length + "] => [" + a + "]"), !1;
            return !0
        })
    }
...
function atcb_validate_icsFile(e, a, t = "", n = "") {
    ...
    return !("" != t && (!atcb_secure_url(t, !1) || !/^https:\/\/(.)*\.ics$/m.test(e.icsFile) && !e.subscribe || !e.icsFile.startsWith("https://") && e.subscribe)) || (console.error(a + " failed: explicit ics file path not valid" + n), !1)
}
...
function atcb_validate_availability(e, a, t, n) {
    return null == e.dates["" + t].availability || "" == e.dates["" + t].availability || "free" == e.dates["" + t].availability || "busy" == e.dates["" + t].availability || (console.error(a + ' failed: event availability needs to be "free" or "busy"' + n), !1)
}
...
function atcb_validate_uid(e, a, t, n) {
    return /^(\w|-){1,254}$/.test(e.dates["" + t].uid) || (console.warn(a + ": UID not valid. May only contain alpha, digits, and dashes; and be less than 255 characters. Falling back to an automated value!" + n), e.dates["" + t].uid = atcb_generate_uuid()), /^[0-9a-f]{8}-[0-9a-f]{4}-[0-5][0-9a-f]{3}-[089ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(e.dates["" + t].uid) || console.warn(a + ": UID is highly recommended to be a hex-encoded random Universally Unique Identifier (UUID)!" + n), !0
}
...
function atcb_validate_datetime(t, n, o, i) {
    ...
    return !!e.every(function (e) {
        var a;
        return 10 !== t.dates["" + o]["" + e].length ? (console.error(n + " failed: date misspelled [-> YYYY-MM-DD]" + i), !1) : (a = t.dates["" + o]["" + e].split("-")).length < 3 || 3 < a.length ? (console.error(n + " failed: date misspelled [" + e + ": " + t.dates["" + o]["" + e] + "]" + i), !1) : (l["" + e] = new Date(a[0], a[1] - 1, a[2]), !0)
...
function atcb_close(a = !1) {
    ...
    if (1 < t.length) {
        ...
        t && (t.focus({
            preventScroll: !0
        }), a || t.blur()), Array.from(document.querySelectorAll(".atcb-active")).forEach(e => {
...
function atcb_generate_label(a, t, n, e = !1, o = "", i = !1) {
    switch (n) {
        case "trigger":
        default:
            t.id = a.identifier, "click" === a.trigger ? t.addEventListener("click", e => {
        ...
        case "outlookcom":
        case "yahoo":
            t.id = a.identifier + "-" + n, t.addEventListener("click", atcb_debounce(() => {
            ...
            break;
        case "close":
            t.id = a.identifier + "-close", t.addEventListener("click", atcb_debounce(() => {
                atcb_toggle("close")
            })), t.addEventListener("keyup", function (e) {
...
function atcb_generate_label_content(e, a, t, n, o, i) {
    ...
    "date" == e.buttonStyle && ("trigger" == t || i) || (n && ((i = document.createElement("span")).classList.add("atcb-icon"), i.innerHTML = atcbIcon["" + t], a.appendChild(i)), ("trigger" == t && 1 == e.textLabelButton || "trigger" != t && 1 == e.textLabelList) && ((n = document.createElement("span")).classList.add("atcb-text"), n.textContent = o, a.appendChild(n)))
}
...
function atcb_generate_button(e, a) {
    ...
    n.classList.add("atcb-button"), 0 == a.textLabelButton && n.classList.add("atcb-no-text"), "click" === a.trigger && n.classList.add("atcb-click"), "overlay" === a.listStyle && n.classList.add("atcb-dropoverlay"), n.type = "button", t.appendChild(n), "date" == a.buttonStyle && atcb_generate_date_button(a, n), 1 === a.options.length ? (n.classList.add("atcb-single"), atcb_generate_label(a, n, a.options[0], a.iconButton, a.label, !0)) : (atcb_generate_label(a, n, "trigger", a.iconButton, a.label), (t = document.createElement("div")).classList.add("atcb-dropdown-anchor"), n.appendChild(t)), a.checkmark && ((t = document.createElement("div")).classList.add("atcb-checkmark"), t.innerHTML = atcbIcon.checkmark, n.appendChild(t)), e.classList.remove("atcb"), e.classList.add("atcb-initialized"), a.inline ? e.style.display = "inline-block" : e.style.display = "block", console.log('Add to Calendar Button "' + a.identifier + '" created')
}

function atcb_generate_rich_data(a, e) {
    var t, n = document.createElement("script"),
        o = (n.type = "application/ld+json", []),
        i = (1 < a.dates.length && ((t = []).push('"@context":"https://schema.org"'), t.push('"@type":"EventSeries"'), t.push('"@id":"' + a.name.replace(/\s/g, "") + '"'), t.push('"name":"' + a.name + '",'), o.push("{\r\n" + t.join(",\r\n") + "\r\n")), []);
    for (let e = 0; e < a.dates.length; e++) {
        var l = [],
            r = (l.push('"@context":"https://schema.org"'), l.push('"@type":"Event"'), 1 < a.dates.length && l.push('"@id":"' + a.name.replace(/\s/g, "") + "-" + (e + 1) + '"'), "CANCELLED" == a.dates["" + e].status && l.push('"eventStatus":"https://schema.org/EventCancelled"'), l.push('"name":"' + a.dates["" + e].name + '"'), a.dates["" + e].descriptionHtmlFree && l.push('"description":"' + a.dates["" + e].descriptionHtmlFree + '"'), atcb_generate_time(a.dates["" + e], "delimiters", "general", !0)),
            s = (l.push('"startDate":"' + r.start + '"'), null != r.duration && l.push('"duration":"' + r.duration + '"'), l.push(a.dates["" + e].location.startsWith("http") ? '"eventAttendanceMode":"https://schema.org/OnlineEventAttendanceMode",\r\n"location": {\r\n"@type":"VirtualLocation",\r\n"url":"' + a.dates["" + e].location + '"\r\n}' : '"location":"' + a.dates["" + e].location + '"'), null != a.recurrence && "" != a.recurrence ? l.push(...atcb_generate_rich_data_recurrence(a, r)) : l.push('"endDate":"' + r.end + '"'), null != a.dates["" + e].organizer && "" != a.dates["" + e].organizer && (r = a.dates["" + e].organizer.split("|"), l.push('"organizer":{\r\n"@type":"Person",\r\n"name":"' + r[0] + '",\r\n"email":"' + r[1] + '"\r\n}')), []);
        if (null != a.images) {
            if (Array.isArray(a.images))
                for (let e = 0; e < a.images.length; e++) atcb_secure_url(a.images["" + e]) && a.images["" + e].startsWith("http") && s.push('"' + a.images["" + e] + '"')
...
function atcb_generate_rich_data_recurrence(e, a) {
    var t = [],
        n = (t.push('"eventSchedule": { "@type": "Schedule"'), null != e.dates[0].timeZone && "" != e.dates[0].timeZone && t.push('"scheduleTimezone":"' + e.dates[0].timeZone + '"'), "P" + e.recurrence_interval + e.recurrence_frequency.substr(0, 1));
    return t.push('"repeatFrequency":"' + n + '"'), null != e.recurrence_byDay && "" != e.recurrence_byDay && (n = function () {
        ...
        return "[" + n.join(",") + "]"
    }(), t.push('"byDay":' + n)), null != e.recurrence_byMonth && "" != e.recurrence_byMonth && (n = e.recurrence_byMonth.includes(",") ? "[" + e.recurrence_byMonth + "]" : e.recurrence_byMonth, t.push('"byMonth":"' + n + '"')), null != e.recurrence_byMonthDay && "" != e.recurrence_byMonthDay && (n = e.recurrence_byMonthDay.includes(",") ? "[" + e.recurrence_byMonthDay + "]" : e.recurrence_byMonthDay, t.push('"byMonthDay":"' + n + '"')), null != e.recurrence_count && "" != e.recurrence_count && t.push('"repeatCount":"' + e.recurrence_count + '"'), null != e.recurrence_until && "" != e.recurrence_until && t.push('"endDate":"' + e.recurrence_until + '"'), null != e.startTime && "" != e.startTime && null != e.endTime && "" != e.endTime && (t.push('"startTime":"' + e.startTime + ':00"'), t.push('"endTime":"' + e.endTime + ':00"'), t.push('"duration":"' + a.duration + '"')), t.push('"startDate":"' + e.startDate + '" }'), t
}
...
function atcb_generate_dropdown_list(t) {
    ...
    }), "modal" === t.listStyle && ((e = document.createElement("div")).classList.add("atcb-list-item", "atcb-list-item-close"), e.tabIndex = 0, n.appendChild(e), atcb_generate_label(t, e, "close", t.iconList)), n
}

function atcb_generate_bg_overlay(e = "dropdown", a = "", t = "light", n = !0) {
    var o = document.createElement("div");
    o.id = "atcb-bgoverlay", "modal" !== e && n && o.classList.add("atcb-animate-bg"), n || o.classList.add("atcb-no-bg"), o.classList.add("atcb-" + t), o.tabIndex = 0, o.addEventListener("click", atcb_debounce(e => {
...
function atcb_create_modal(n, e = "", a, t = "", o = [], i = [], l = !1) {
    var r = document.getElementById("atcb-bgoverlay") || atcb_generate_bg_overlay("modal", "click", n.lightMode, n.background),
        ...
        d = (s.dataset.modalNr = c, s.tabIndex = 0, s.focus({
            preventScroll: !0
        }), s.blur(), document.getElementById(n.identifier)),
        d = (null != d && d.classList.add("atcb-active-modal"), document.createElement("div")),
        e = (d.classList.add("atcb-modal-box"), d.classList.add("atcb-" + n.lightMode), n.rtl && d.classList.add("atcb-rtl"), s.appendChild(d), atcb_set_sizes(d, n.sizes), atcb_set_fullsize(r), "" != e && 1 == n.iconModal && ((r = document.createElement("div")).classList.add("atcb-modal-icon"), r.innerHTML = atcbIcon["" + e], d.appendChild(r)), document.createElement("div"));
    if (e.classList.add("atcb-modal-headline"), e.textContent = a, d.appendChild(e), "" != t && ((r = document.createElement("div")).classList.add("atcb-modal-content"), r.innerHTML = t, d.appendChild(r)), 1 < i.length) {
        ...
        for (let e = 1; e < i.length; e++) {
            ...
            switch (m.type = "button", m.id = n.identifier + "-" + i[0] + "-" + e, 0 < atcbStates["" + n.identifier]["" + i[0]][e - 1] && m.classList.add("atcb-saved"), m.classList.add("atcb-subevent-btn"), u.appendChild(m), atcb_generate_date_button(n, m, e), 1 == e && l && m.focus(), i[0]) {
                case "apple":
                case "google":
                case "ical":
                case "msteams":
    ...
    b.classList.add("atcb-modal-buttons"), d.appendChild(b), o.forEach((e, a) => {
        let t;
        switch (null != e.href && "" != e.href ? ((t = document.createElement("a")).setAttribute("target", atcbDefaultTarget), t.setAttribute("href", e.href), t.setAttribute("rel", "noopener")) : (t = document.createElement("button")).type = "button", t.classList.add("atcb-modal-btn"), e.primary && t.classList.add("atcb-modal-btn-primary"), null != e.label && "" != e.label || (e.label = atcb_translate_hook("Click me", n)), t.textContent = e.label, b.appendChild(t), 0 == a && i.length < 2 && l && t.focus(), e.type) {
            default:
            case "close":
                t.addEventListener("click", atcb_debounce(() => atcb_close())), t.addEventListener("keyup", function (e) {
    ...
    }), 1 < c && (document.querySelectorAll('.atcb-modal[data-modal-nr="' + (c - 1) + '"]')[0].style.display = "none"), atcb_manage_body_scroll(s)
}
...
function atcb_generate_date_button(u, e, m = "all") {
    ...
    var a = function () {
            let e, a, t, n, o = {},
                i = {},
                l = (n = "all" == m ? (o = atcb_generate_time(u.dates[0]), i = atcb_generate_time(u.dates[u.dates.length - 1]), t = u.dates[0].timeZone, u.dates[u.dates.length - 1].timeZone) : (o = atcb_generate_time(u.dates["" + m]), i = o, t = u.dates["" + m].timeZone), e = new Date(o.start), a = new Date(i.end), null != t && "" != t && !o.allday || (t = "UTC"), null != n && "" != n && !i.allday || (n = "UTC"), ""),
                r = "",
                s = "";
            ...
            return e.getFullYear() === a.getFullYear() && e.getMonth() === a.getMonth() && e.getDate() === a.getDate() ? l = o.allday ? e.toLocaleDateString(u.language, c.DateShort) : e.toLocaleString(u.language, c.DateTimeShort) + r + " - " + a.toLocaleTimeString(u.language, d.Time) + s : (l = o.allday ? e.toLocaleDateString(u.language, c.DateShort) : e.toLocaleString(u.language, c.DateTimeShort), l += r + " - ", i.allday ? l += a.toLocaleDateString(u.language, d.DateLong) : l += a.toLocaleString(u.language, d.DateTimeLong), l += s), l
        }(),
        ...
        r = (s.classList.add("atcb-date-btn-month"), r.textContent = o.toLocaleString(u.language, {
            day: "numeric",
            timeZone: i
        }), s.textContent = o.toLocaleString(u.language, {
            month: "short",
            timeZone: i
        }), l.appendChild(s), document.createElement("div")),
        ...
        o = (l.textContent = a, n.appendChild(l), null != u.recurrence && "" != u.recurrence && ((i = document.createElement("span")).classList.add("atcb-date-btn-content-recurr-icon"), n.appendChild(i), i.innerHTML = "&#x27F3;"), document.createElement("div"));
...
function atcb_generate_links(e, a, t = "all", n = !1, o = !1) {
    if ("all" != t ? t = parseInt(t) - 1 : 1 == a.dates.length && (t = 0), a.subscribe) atcb_generate_subscribe_links(e, a, n);
        ...
        var i = document.getElementById(a.identifier + "-" + e + "-" + (t + 1)),
            i = (i && i.classList.add("atcb-saved"), atcbStates["" + a.identifier]["" + e]["" + t]++, atcbStates["" + a.identifier]["" + e].filter(function (e) {
                return e < 1
            }));
...
function atcb_generate_subscribe_links(e, a, t) {
    ...
    switch (e) {
        ...
        case "outlookcom":
            ...
            break;
        case "yahoo":
            return atcb_copy_to_clipboard(a.icsFile), void atcb_create_modal(a, "yahoo", atcb_translate_hook("modal.subscribe.yahoo.h", a), atcb_translate_hook("modal.clipboard.text", a) + "<br>" + atcb_translate_hook("modal.subscribe.yahoo.text", a), [{
...
function atcb_generate_google(e) {
    var a = [],
        ...
        t = (a.push("dates=" + encodeURIComponent(t.start) + "%2F" + encodeURIComponent(t.end)), null == e.timeZone || "" == e.timeZone || /(GMT[+|-]\d{1,2}|Etc\/U|Etc\/Zulu|CET|CST6CDT|EET|EST|EST5EDT|MET|MST|MST7MDT|PST8PDT|WET)/i.test(e.timeZone) || a.push("ctz=" + e.timeZone), null != e.name && "" != e.name && a.push("text=" + encodeURIComponent(e.name)), []);
    null != e.description && "" != e.description && t.push(e.description), null != e.location && "" != e.location && (a.push("location=" + encodeURIComponent(e.location)), isiOS() && (0 < t.length && t.push("<br><br>"), t.push("&#128205;: " + e.location))), 0 < t.length && a.push("details=" + encodeURIComponent(t.join())), null != e.recurrence && "" != e.recurrence && a.push("recur=" + encodeURIComponent(e.recurrence)), null != e.availability && "" != e.availability && (t = "free" == e.availability ? "crm=AVAILABLE&trp=false" : "crm=BUSY&trp=true", a.push(t)), a.push("uid=" + encodeURIComponent(e.uid)), atcb_open_cal_url(a.join("&"))
}

function atcb_generate_yahoo(e) {
    var a = [],
        t = (a.push("https://calendar.yahoo.com/?v=60"), atcb_generate_time(e, "clean"));
    a.push("st=" + encodeURIComponent(t.start) + "&et=" + encodeURIComponent(t.end)), t.allday && a.push("dur=allday"), null != e.name && "" != e.name && a.push("title=" + encodeURIComponent(e.name)), null != e.location && "" != e.location && a.push("in_loc=" + encodeURIComponent(e.location)), null != e.descriptionHtmlFree && "" != e.descriptionHtmlFree && a.push("desc=" + encodeURIComponent(e.descriptionHtmlFree)), atcb_open_cal_url(a.join("&"))
}
...
function atcb_generate_microsoft(e, a = "365") {
    ...
    t.push("startdt=" + encodeURIComponent(a.start)), t.push("enddt=" + encodeURIComponent(a.end)), a.allday && t.push("allday=true"), null != e.name && "" != e.name && t.push("subject=" + encodeURIComponent(e.name)), null != e.location && "" != e.location && t.push("location=" + encodeURIComponent(e.location)), null != e.description && "" != e.description && t.push("body=" + encodeURIComponent(e.description.replace(/\n/g, "<br>"))), t.push("uid=" + encodeURIComponent(e.uid)), atcb_open_cal_url(t.join("&"))
}
...
function atcb_generate_msteams(e) {
    ...
    let n = "";
    null != e.location && "" != e.location && (n = encodeURIComponent(e.location), a.push("location=" + n), n += " // "), null != e.descriptionHtmlFree && "" != e.descriptionHtmlFree && a.push("content=" + n + encodeURIComponent(e.descriptionHtmlFree)), a.push("uid=" + encodeURIComponent(e.uid)), atcb_open_cal_url("https://teams.microsoft.com/l/meeting/new?" + a.join("&"))
}
...
function atcb_ical_copy_note(e, a, t) {
    atcb_copy_to_clipboard(e), isiOS() && isChrome() ? atcb_create_modal(a, "warning", atcb_translate_hook("modal.crios.ical.h", a), atcb_translate_hook("modal.crios.ical.text", a) + "<br>" + atcb_translate_hook("modal.clipboard.text", a) + "<br>" + atcb_translate_hook("modal.crios.ical.steps", a), [], [], t) : atcb_create_modal(a, "warning", atcb_translate_hook("modal.webview.ical.h", a), atcb_translate_hook("modal.webview.ical.text", a) + "<br>" + atcb_translate_hook("modal.clipboard.text", a) + "<br>" + atcb_translate_hook("modal.webview.ical.steps", a), [], [], t)
}
...
function atcb_save_file(e, a) {
    try {
        var t = document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
            n = (t.rel = "noopener", t.href = e, isMobile() ? t.target = "_self" : t.target = "_blank", t.download = a + ".ics", new MouseEvent("click", {
                view: window,
                button: 0,
                bubbles: !0,
                cancelable: !1
...
function atcb_generate_time(e, a = "delimiters", t = "general", n = !1) {
    if (null == e.startTime || "" == e.startTime || null == e.endTime || "" == e.endTime) return o = e.startDate.split("-"), i = e.endDate.split("-"), o = new Date(Date.UTC(o[0], o[1] - 1, o[2], 12, 0, 0)), i = new Date(Date.UTC(i[0], i[1] - 1, i[2], 12, 0, 0)), "google" != t && "microsoft" != t && "ical" != t || i.setDate(i.getDate() + 1), {
        ...
        if ((null == e.timeZone || null != e.timeZone && "" == e.timeZone) && n) return {
        ...
        if (null != e.timeZone && "" != e.timeZone) {
            if ("ical" == t || "google" == t && !/(GMT[+|-]\d{1,2}|Etc\/U|Etc\/Zulu|CET|CST6CDT|EET|EST|EST5EDT|MET|MST|MST7MDT|PST8PDT|WET)/i.test(e.timeZone)) return {
            ...
            if (n) return n = t.slice(0, 3) + ":" + t.slice(3), r = e.slice(0, 3) + ":" + e.slice(3), {
...
function atcb_secure_url(e, a = !0) {
    return !e.match(/((\.\.\/)|(\.\.\\)|(%2e%2e%2f)|(%252e%252e%252f)|(%2e%2e\/)|(%252e%252e\/)|(\.\.%2f)|(\.\.%252f)|(%2e%2e%5c)|(%252e%252e%255c)|(%2e%2e\\)|(%252e%252e\\)|(\.\.%5c)|(\.\.%255c)|(\.\.%c0%af)|(\.\.%25c0%25af)|(\.\.%c1%9c)|(\.\.%25c1%259c))/gi) || (a && console.error("Seems like the generated URL includes at least one security issue and got blocked. Please check the calendar button parameters!"), !1)
}
...
function atcb_copy_to_clipboard(e) {
    var a, t, n = document.createElement("input"),
        o = (document.body.appendChild(n), n.contentEditable),
        i = n.readOnly;
    n.value = e, n.contentEditable = !0, n.readOnly = !1, isiOS() ? ((a = document.createRange()).selectNodeContents(n), (t = window.getSelection()).removeAllRanges(), t.addRange(a), n.setSelectionRange(0, 999999)) : (navigator.clipboard.writeText(e), n.select()), n.contentEditable = o, n.readOnly = i, document.execCommand("copy"), n.remove()
}
...
function atcb_debounce_leading(a, t = 300) {
    let n;
    return (...e) => {
        n || a.apply(this, e), clearTimeout(n), n = setTimeout(() => {
            n = void 0
        }, t)
    }
}
...
const i18nStrings = {
    ...
    de: {
        ...
        Close: "SchlieÃŸen",
        "Close Selection": "Auswahl schlieÃŸen",
        "Click me": "Klick mich",
        "modal.webview.ical.h": "Ã–ffne deinen Browser",
        ...
        "modal.webview.ical.steps": "<ol><li><strong>Ã–ffne einen anderen Browser</strong> auf deinem Smartphone, ...</li><li>Nutze die <strong>EinfÃ¼gen</strong>-Funktion, um fortzufahren.</li></ol>",
        "modal.crios.ical.h": "Ã–ffne Safari",
        "modal.crios.ical.text": "Leider Chrome unter iOS Probleme mit der Art, wie wir Kalender-Dateien erzeugen.",
        "modal.crios.ical.steps": "<ol><li><strong>Ã–ffne Safari</strong>, ...</li><li>Nutze die <strong>EinfÃ¼gen</strong>-Funktion, um fortzufahren.</li></ol>",
        "modal.multidate.h": "Dies is eine Termin-Reihe",
        "modal.multidate.text": "FÃ¼ge die einzelnen Termine der Reihe nach deinem Kalender hinzu:",
        Event: "Termin",
        "Cancelled Date": "Dieser Termin wurde abgesagt.",
        "Delete from Calendar": "Bitte aktualisiere deinen Kalender!",
        "modal.subscribe.yahoo.h": "Kalender zu Yahoo hinzufÃ¼gen",
        "modal.subscribe.yahoo.text": '<ol><li>Ã–ffne den Yahoo Kalender.</li><li>Klicke auf den "Aktionen" Tab.</li><li>WÃ¤hle "Weiteren Kalendern folgen".</li><li>WÃ¤hle einen Namen und fÃ¼ge die URL aus deiner Zwischenablage in das URL-Feld ein.</li></ol>',
        Cancel: "Abbrechen"
    },
    es: {
        "Add to Calendar": "AÃ±adir al Calendario",
        "iCal File": "iCal Ficha",
        Close: "CiÃ©rralo",
        "Close Selection": "Cerrar SelecciÃ³n",
        "Click me": "Haz clic mÃ­",
        ...
        "modal.clipboard.text": "Hemos copiado automÃ¡ticamente una URL mÃ¡gica en su portapapeles.",
        "modal.webview.ical.steps": "<ol><li><strong>Abre otro browser</strong> en tu smartphone, ...</li><li>Utilice la funciÃ³n de <strong>pegar</strong> para continuar.</li></ol>",
        ...
        "modal.crios.ical.steps": "<ol><li><strong>Abrir Safari</strong>, ...</li><li>Utilice la funciÃ³n de <strong>pegar</strong> para continuar.</li></ol>",
        "modal.multidate.h": "Esta es una serie de fechas",
        "modal.multidate.text": "AÃ±ada las fechas individuales a su calendario en orden:",
        Event: "TÃ©rmino",
        "Cancelled Date": "Esta fecha fue cancelada.",
        "Delete from Calendar": "Actualice su calendario!",
        "modal.subscribe.yahoo.h": "AÃ±adir calendario a Yahoo",
        "modal.subscribe.yahoo.text": '<ol><li>Abra el calendario de Yahoo.</li><li>Haga clic en la pestaÃ±a "Acciones".</li><li>Seleccione "Seguir otros calendarios".</li><li>Elige un nombre y pega la URL de tu portapapeles en el campo URL.</li></ol>',
        Cancel: "Cancelar"
    },
    pt: {
        "Add to Calendar": "Incluir no CalendÃ¡rio",
        "iCal File": "Ficheiro iCal",
        Close: "Fechar",
        "Close Selection": "Fechar selecÃ§Ã£o",
        "Click me": "Clicar-me",
        "modal.webview.ical.h": "Abra o seu browser",
        "modal.webview.ical.text": "Infelizmente, os navegadores em tampas tÃªm problemas com a forma como geramos o ficheiro de calendÃ¡rio.",
        "modal.clipboard.text": "CopiÃ¡mos automaticamente um URL mÃ¡gico para a sua Ã¡rea de transferÃªncia.",
        "modal.webview.ical.steps": "<ol><li><strong>Abrir outro browser</strong> en tu smartphone, ...</li><li>Use a funÃ§Ã£o <forte>colar</strong> para continuar.</li></ol>",
        "modal.crios.ical.h": "Safari aberto",
        "modal.crios.ical.text": "Infelizmente, o cromado no iOS tem problemas com a forma como geramos o ficheiro do calendÃ¡rio.",
        "modal.crios.ical.steps": "<ol><li><strong>Safari aberto</strong>, ...</li><li>Use a funÃ§Ã£o <forte>colar</strong> para continuar.</li></ol>",
        "modal.multidate.h": "Esta Ã© uma sÃ©rie de datas",
        "modal.multidate.text": "Adicione as datas individuais ao seu calendÃ¡rio, por ordem:",
        Event: "Termo",
        "Cancelled Date": "Esta data foi cancelada.",
        "Delete from Calendar": "Actualize o seu calendÃ¡rio!",
        "modal.subscribe.yahoo.h": "Adicionar calendÃ¡rio ao Yahoo",
        "modal.subscribe.yahoo.text": '<ol><li>Abrir o calendÃ¡rio do Yahoo.</li><li>Clique no separador "AcÃ§Ãµes".</li><li>Seleccione "Seguir outros calendÃ¡rios".</li><li>Escolha um nome e cole o URL da sua Ã¡rea de transferÃªncia no campo URL.</li></ol>',
        Cancel: "Cancelar"
    },
    fr: {
        ...
        Close: "Fermez",
        "Close Selection": "Fermez la sÃ©lection",
        "Click me": "Cliquez-moi",
        "modal.webview.ical.h": "Ouvrez votre navigateur",
        "modal.webview.ical.text": "Malheureusement, les navigateurs in-app ont des problÃ¨mes avec la maniÃ¨re dont nous crÃ©ons les fichiers de agenda.",
        "modal.clipboard.text": "Nous avons automatiquement copiÃ© une URL magique dans ton presse-papiers.",
        "modal.webview.ical.steps": "<ol><li><strong>Ouvre un autre navigateur</strong> sur ton smartphone, ...</li><li>Utilise la fonction <strong>insÃ©rer</strong> pour continuer.</li></ol>",
        "modal.crios.ical.h": "Ouvre Safari",
        "modal.crios.ical.text": "Malheureusement, Chrome sur iOS a des problÃ¨mes avec la faÃ§on dont nous gÃ©nÃ©rons le fichier du agenda.",
        "modal.crios.ical.steps": "<ol><li><strong>Ouvre Safari</strong>, ...</li><li>Utilise la fonction <strong>insÃ©rer</strong> pour continuer.</li></ol>",
        "modal.multidate.h": "Il s'agit d'une sÃ©rie d'Ã©vÃ©nements",
        "modal.multidate.text": "Ajoute les diffÃ©rents rendez-vous dans l'ordre Ã  ton agenda:",
        Event: "Terminaison",
        "Cancelled Date": "Cette date est annulÃ©e.",
        "Delete from Calendar": "Actualisez votre agenda!",
        "modal.subscribe.yahoo.h": "Ajouter un agenda Ã  Yahoo",
        "modal.subscribe.yahoo.text": '<ol><li>Ouvre le Yahoo calendar.</li><li>Clique sur l\'onglet "Actions".</li><li>SÃ©lectionne "Suivre d\'autres agendas".</li><li>Choisis un nom et colle l\'URL de ton presse-papiers dans le champ URL.</li></ol>',
        Cancel: "Annuler"
    },
    nl: {
        ...
        "modal.multidate.text": "Voeg de afzonderlijke delen Ã©Ã©n voor Ã©Ã©n toe:",
        Event: "Termin",
    ...
    tr: {
        ...
        Close: "Kapat",
        "Close Selection": "SeÃ§imi kapat",
        "Click me": "Beni tÄ±klayÄ±n",
        "modal.webview.ical.h": "TarayÄ±cÄ±nÄ±zÄ± aÃ§Ä±n",
        "modal.webview.ical.text": "Ne yazÄ±k ki, uygulama iÃ§i tarayÄ±cÄ±lar takvim dosyalarÄ±nÄ± oluÅŸturma ÅŸeklimizle ilgili sorunlar yaÅŸÄ±yor.",
        "modal.clipboard.text": "Panonuza otomatik olarak sihirli bir URL kopyaladÄ±k.",
        "modal.webview.ical.steps": "<ol><li><strong>AkÄ±llÄ± telefonunuzda baÅŸka bir tarayÄ±cÄ± aÃ§Ä±n</strong>, ...</li><li>Devam etmek iÃ§in <strong>insert</strong> fonksiyonunu kullanÄ±n.</li></ol>",
        "modal.crios.ical.h": "AÃ§Ä±k Safari",
        "modal.crios.ical.text": "Ne yazÄ±k ki iOS'ta Chrome'un takvim dosyasÄ± oluÅŸturma yÃ¶ntemiyle ilgili sorunlarÄ± var.",
        "modal.crios.ical.steps": "<ol><li><strong>AÃ§Ä±k Safari</strong>, ...</li><li>Devam etmek iÃ§in <strong>insert</strong> fonksiyonunu kullanÄ±n.</li></ol>",
        "modal.multidate.h": "Bu bir etkinlik serisidir",
        "modal.multidate.text": "ParÃ§alarÄ± teker teker ekleyin:",
        Event: "Etkinlik",
        "Cancelled Date": "Bu tarih iptal edildi.",
        "Delete from Calendar": "LÃ¼tfen takviminizi gÃ¼ncelleyin!",
        "modal.subscribe.yahoo.h": "Yahoo'ya takvim ekleme",
        "modal.subscribe.yahoo.text": '<ol><li>Yahoo takvimini aÃ§Ä±n.</li><li>"Eylemler" sekmesine tÄ±klayÄ±n.</li><li>"DiÄŸer Takvimleri Takip Et" Ã¶ÄŸesini seÃ§in.</li><li>Bir ad seÃ§in ve URL\'yi panonuzdan URL alanÄ±na yapÄ±ÅŸtÄ±rÄ±n.</li></ol>',
        Cancel: "Ä°ptal"
    },
    zh: {
        "Add to Calendar": "æ·»åŠ åˆ°æ—¥åŽ†",
        "iCal File": "iCal æ–‡ä»¶",
        Close: "å…³",
        "Close Selection": "å…³é—­é€‰æ‹©",
        "Click me": "ç‚¹æˆ‘",
        "modal.webview.ical.h": "æ‰“å¼€æµè§ˆå™¨",
        "modal.webview.ical.text": "ä¸å¹¸çš„æ˜¯ï¼Œåº”ç”¨å†…æµè§ˆå™¨åœ¨æˆ‘ä»¬ç”Ÿæˆæ—¥åŽ†æ–‡ä»¶çš„æ–¹å¼ä¸Šå­˜åœ¨é—®é¢˜ã€‚",
        "modal.clipboard.text": "æˆ‘ä»¬è‡ªåŠ¨å°†é­”æœ¯ URL å¤åˆ¶åˆ°æ‚¨çš„å‰ªè´´æ¿ã€‚",
        "modal.webview.ical.steps": "<ol><li>æ‰“å¼€æ‰‹æœºä¸Šçš„ä»»ä½•å…¶ä»–æµè§ˆå™¨, ...</li><li>ç²˜è´´å‰ªè´´æ¿å†…å®¹å¹¶å¼€å§‹ã€‚</li></ol>",
        "modal.crios.ical.h": "æ‰“å¼€ Safari",
        "modal.crios.ical.text": "ä¸å¹¸çš„æ˜¯ï¼ŒiOS ä¸Šçš„ Chrome åœ¨æˆ‘ä»¬ç”Ÿæˆæ—¥åŽ†æ–‡ä»¶çš„æ–¹å¼ä¸Šå­˜åœ¨é—®é¢˜ã€‚",
        "modal.crios.ical.steps": "<ol><li><strong>æ‰“å¼€ Safari</strong>, ...</li><li>ç²˜è´´å‰ªè´´æ¿å†…å®¹å¹¶å¼€å§‹ã€‚</li></ol>",
        "modal.multidate.h": "è¿™æ˜¯ä¸€ä¸ªæ´»åŠ¨ç³»åˆ—",
        "modal.multidate.text": "é€ä¸ªæ·»åŠ å„ä¸ªéƒ¨åˆ†:",
        Event: "äº‹ä»¶",
        "Cancelled Date": "æ­¤æ—¥æœŸå·²å–æ¶ˆã€‚",
        "Delete from Calendar": "è¯·æ›´æ–°æ‚¨çš„æ—¥åŽ†!",
        "modal.subscribe.yahoo.h": "å°†æ—¥åŽ†æ·»åŠ åˆ° Yahoo",
        "modal.subscribe.yahoo.text": "<ol><li>æ‰“å¼€ Yahoo æ—¥åŽ†ã€‚</li><li>ç‚¹å‡»â€œæ“ä½œâ€æ ‡ç­¾ã€‚</li><li>é€‰æ‹©â€œå…³æ³¨å…¶ä»–æ—¥åŽ†â€ã€‚</li><li>é€‰æ‹©ä¸€ä¸ªåç§°å¹¶å°†å‰ªè´´æ¿ä¸­çš„ URL ç²˜è´´åˆ° URL å­—æ®µä¸­ã€‚</li></ol>",
        Cancel: "ä¸­æ­¢"
    },
    ar: {
        "Add to Calendar": "Ø¥Ø¶Ø§ÙØ© Ø¥Ù„Ù‰ Ø§Ù„ØªÙ‚ÙˆÙŠÙ…",
        "iCal File": "Ù…Ù„Ù iCal",
        Close: "Ù‚Ø±ÙŠØ¨",
        "Close Selection": "Ø¥ØºÙ„Ø§Ù‚ Ø§Ù„ØªØ­Ø¯ÙŠØ¯",
        "Click me": "Ø§Ù†Ù‚Ø± ÙÙˆÙ‚ Ù„ÙŠ",
        "modal.webview.ical.h": "Ø§ÙØªØ­ Ø§Ù„Ù…Ø³ØªØ¹Ø±Ø¶ Ø§Ù„Ø®Ø§Øµ Ø¨Ùƒ",
        "modal.webview.ical.text": "Ù„Ø³ÙˆØ¡ Ø§Ù„Ø­Ø¸ ØŒ ØªÙˆØ§Ø¬Ù‡ Ø§Ù„Ù…ØªØµÙØ­Ø§Øª Ø¯Ø§Ø®Ù„ Ø§Ù„ØªØ·Ø¨ÙŠÙ‚ Ù…Ø´Ø§ÙƒÙ„ ÙÙŠ Ø·Ø±ÙŠÙ‚Ø© Ø¥Ù†Ø´Ø§Ø¡ Ù…Ù„Ù Ø§Ù„ØªÙ‚ÙˆÙŠÙ….",
        "modal.clipboard.text": "Ù‚Ù…Ù†Ø§ ØªÙ„Ù‚Ø§Ø¦ÙŠÙ‹Ø§ Ø¨Ù†Ø³Ø® Ø¹Ù†ÙˆØ§Ù† URL Ø³Ø­Ø±ÙŠ Ø¥Ù„Ù‰ Ø§Ù„Ø­Ø§ÙØ¸Ø© Ø§Ù„Ø®Ø§ØµØ© Ø¨Ùƒ.",
        "modal.webview.ical.steps": "<ol><li>Ø§ÙØªØ­ Ø£ÙŠ Ù…ØªØµÙØ­ Ø¢Ø®Ø± Ø¹Ù„Ù‰ Ù‡Ø§ØªÙÙƒ Ø§Ù„Ø°ÙƒÙŠ, ...</li><li>.Ø§Ù„ØµÙ‚ Ù…Ø­ØªÙˆÙ‰ Ø§Ù„Ø­Ø§ÙØ¸Ø© ÙˆØ§Ø°Ù‡Ø¨</li></ol>",
        "modal.crios.ical.h": "Ø§ÙØªØ­ Safari",
        "modal.crios.ical.text": "Ù„Ø³ÙˆØ¡ Ø§Ù„Ø­Ø¸ ØŒ ÙŠÙˆØ§Ø¬Ù‡ Chrome Ø¹Ù„Ù‰ iOS Ù…Ø´Ø§ÙƒÙ„ ÙÙŠ Ø·Ø±ÙŠÙ‚Ø© Ø¥Ù†Ø´Ø§Ø¡ Ù…Ù„Ù Ø§Ù„ØªÙ‚ÙˆÙŠÙ…",
        ...
        "modal.multidate.text": "Ø£Ø¶Ù Ø§Ù„Ø£Ø¬Ø²Ø§Ø¡ Ø§Ù„ÙØ±Ø¯ÙŠØ© ÙˆØ§Ø­Ø¯Ø© ØªÙ„Ùˆ Ø§Ù„Ø£Ø®Ø±Ù‰:",
        Event: "Ø­Ø¯Ø«",
        "Cancelled Date": "ØªÙ… Ø¥Ù„ØºØ§Ø¡ Ù‡Ø°Ø§ Ø§Ù„ØªØ§Ø±ÙŠØ®.",
        "Delete from Calendar": "Ø§Ù„Ø±Ø¬Ø§Ø¡ ØªØ­Ø¯ÙŠØ« Ø§Ù„ØªÙ‚ÙˆÙŠÙ… Ø§Ù„Ø®Ø§Øµ Ø¨Ùƒ!",
        "modal.subscribe.yahoo.h": "Ø£Ø¶Ù Ø§Ù„ØªÙ‚ÙˆÙŠÙ… Ø¥Ù„Ù‰ Yahoo",
        "modal.subscribe.yahoo.text": '<ol><li>Ø§ÙØªØ­ ØªÙ‚ÙˆÙŠÙ… Yahoo.</li><li>Ø§Ù†Ù‚Ø± ÙÙˆÙ‚ Ø¹Ù„Ø§Ù…Ø© Ø§Ù„ØªØ¨ÙˆÙŠØ¨ "Ø§Ù„Ø¥Ø¬Ø±Ø§Ø¡Ø§Øª".</li><li>Ø­Ø¯Ø¯ "Ù…ØªØ§Ø¨Ø¹Ø© ØªÙ‚ÙˆÙŠÙ…Ø§Øª Ø£Ø®Ø±Ù‰".</li><li>Ø§Ø®ØªØ± Ø§Ø³Ù…Ù‹Ø§ ÙˆØ§Ù„ØµÙ‚ Ø¹Ù†ÙˆØ§Ù† URL Ù…Ù† Ø§Ù„Ø­Ø§ÙØ¸Ø© Ø§Ù„Ø®Ø§ØµØ© Ø¨Ùƒ ÙÙŠ Ø­Ù‚Ù„ URL.</li></ol>',
        Cancel: "Ø¥Ø­Ø¨Ø§Ø·"
    },
    hi: {
        ...
        Close: "à¤¬à¤‚à¤¦ à¤•à¤°à¤¨à¤¾",
        "Close Selection": "à¤šà¤¯à¤¨ à¤¬à¤‚à¤¦ à¤•à¤°à¥‡à¤‚",
        ...
        "modal.clipboard.text": "à¤¹à¤®à¤¨à¥‡ à¤†à¤ªà¤•à¥‡ à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤ªà¤° à¤¸à¥à¤µà¤šà¤¾à¤²à¤¿à¤¤ à¤°à¥‚à¤ª à¤¸à¥‡ à¤à¤• à¤œà¤¾à¤¦à¥à¤ˆ URL à¤•à¥‰à¤ªà¥€ à¤•à¤° à¤²à¤¿à¤¯à¤¾ à¤¹à¥ˆà¥¤",
        "modal.webview.ical.steps": "<ol><li>à¤…à¤ªà¤¨à¥‡ à¤«à¤¼à¥‹à¤¨ à¤ªà¤° <strong>à¤¦à¥‚à¤¸à¤°à¤¾ à¤¬à¥à¤°à¤¾à¤‰à¤œà¤¼à¤° à¤–à¥‹à¤²à¥‡à¤‚</strong>, ...</li><li>à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤¸à¤¾à¤®à¤—à¥à¤°à¥€ <strong>à¤šà¤¿à¤ªà¤•à¤¾à¤à¤‚</strong> à¤”à¤° à¤œà¤¾à¤à¤‚à¥¤</li></ol>",
        ...
        "modal.crios.ical.steps": "<ol><li><strong>à¤¸à¤«à¤¾à¤°à¥€ à¤–à¥‹à¤²à¥‡à¤‚</strong>, ...</li><li>à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤¸à¤¾à¤®à¤—à¥à¤°à¥€ <strong>à¤šà¤¿à¤ªà¤•à¤¾à¤à¤‚</strong> à¤”à¤° à¤œà¤¾à¤à¤‚à¥¤</li></ol>",
        ...
        "modal.subscribe.yahoo.text": '<ol><li>Yahoo à¤•à¥ˆà¤²à¥‡à¤‚à¤¡à¤° à¤–à¥‹à¤²à¥‡à¤‚à¥¤</li><li>"à¤•à¥ƒà¤¤à¥€" à¤Ÿà¥ˆà¤¬ à¤ªà¤° à¤•à¥à¤²à¤¿à¤• à¤•à¤°à¥‡à¤‚à¥¤</li><li>"à¤‡à¤¤à¤° à¤•à¥…à¤²à¥‡à¤‚à¤¡à¤°à¥à¤¸à¤šà¥‡ à¤…à¤¨à¥à¤¸à¤°à¤£ à¤•à¤°à¤¾" à¤šà¥à¤¨à¥‡à¤‚à¥¤</li><li>à¤à¤• à¤¨à¤¾à¤® à¤šà¥à¤¨à¥‡à¤‚ à¤”à¤° à¤…à¤ªà¤¨à¥‡ à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤¸à¥‡ URL à¤•à¥‹ URL à¤«à¤¼à¥€à¤²à¥à¤¡ à¤®à¥‡à¤‚ à¤ªà¥‡à¤¸à¥à¤Ÿ à¤•à¤°à¥‡à¤‚à¥¤</li></ol>',
    ...
    pl: {
        ...
        "iCal File": "Plik iCal",
        Close: "Zamknij",
        "Close Selection": "Zamknij wybÃ³r",
        "Click me": "Kliknij mnie",
        "modal.webview.ical.h": "OtwÃ³rz przeglÄ…darkÄ™",
        ...
        "modal.webview.ical.steps": "<ol><li><strong>OtwÃ³rz innÄ… przeglÄ…darkÄ™</strong> w swoim telefonie, ...</li><li><strong>Wklej</strong> zawartoÅ›Ä‡ schowka i ruszaj.</li></ol>",
        "modal.crios.ical.h": "OtwÃ³rz Safari",
        "modal.crios.ical.text": "Niestety, Chrome na iOS ma problemy ze sposobem generowania pliku kalendarza.",
        "modal.crios.ical.steps": "<ol><li><strong>OtwÃ³rz Safari</strong>, ...</li><li><strong>Wklej</strong> zawartoÅ›Ä‡ schowka i ruszaj.</li></ol>",
        "modal.multidate.h": "To jest cykl imprez",
        "modal.multidate.text": "DodawaÄ‡ po kolei poszczegÃ³lne czÄ™Å›ci:",
        Event: "Wydarzenie",
        "Cancelled Date": "Ta data zostaÅ‚a odwoÅ‚ana.",
        "Delete from Calendar": "Zaktualizuj swÃ³j kalendarz!",
        "modal.subscribe.yahoo.h": "Dodaj kalendarz do Yahoo",
        "modal.subscribe.yahoo.text": '<ol><li>OtwÃ³rz kalendarz Yahoo.</li><li>Kliknij na zakÅ‚adkÄ™ "CzynnoÅ›ci".</li><li>Wybierz "Obserwuj inne kalendarze".</li><li>Wybierz nazwÄ™ i wklej adres URL ze schowka w polu URL.</li></ol>',
        Cancel: "Anuluj"
    },
    id: {
    ...
    no: {
        ...
        "Click me": "Klikk pÃ¥ meg",
        "modal.webview.ical.h": "Ã…pne nettleseren din",
        "modal.webview.ical.text": "Dessverre har nettlesere i appen problemer med mÃ¥ten vi genererer kalenderfilen pÃ¥.",
        "modal.clipboard.text": "Vi kopierte automatisk en magisk URL til utklippstavlen din.",
        "modal.webview.ical.steps": "<ol><li><strong>Ã…pne en annen nettleser</strong> pÃ¥ telefonen, ...</li><li><strong>Lim inn</strong> innholdet pÃ¥ utklippstavlen og gÃ¥.</li></ol>",
        "modal.crios.ical.h": "Ã…pne Safari",
        "modal.crios.ical.text": "Dessverre har Chrome pÃ¥ iOS problemer med mÃ¥ten vi genererer kalenderfilen pÃ¥.",
        "modal.crios.ical.steps": "<ol><li><strong>Ã…pne Safari</strong>, ...</li><li><strong>Lim inn</strong> innholdet pÃ¥ utklippstavlen og gÃ¥.</li></ol>",
        "modal.multidate.h": "Dette er en avtaleserie",
        "modal.multidate.text": "Legg til de enkelte datoene i kalenderen din i rekkefÃ¸lge:",
        Event: "MÃ¸te",
        ...
        "modal.subscribe.yahoo.text": "<ol><li>Ã…pne Yahoo-kalenderen.</li><li>Klikk pÃ¥ Â«HandlingerÂ»-fanen.</li><li>Velg Â«FÃ¸lg andre kalendereÂ».</li><li>Velg et navn og lim inn URL-en fra utklippstavlen i URL-feltet.</li></ol>",
        Cancel: "Avbryt"
    },
    fi: {
        "Add to Calendar": "LisÃ¤Ã¤ kalenteriin",
        "iCal File": "iCal-tiedosto",
        Close: "Sulje",
        "Close Selection": "Sulje valinta",
        "Click me": "Klikkaa minua",
        "modal.webview.ical.h": "Avaa selain",
        "modal.webview.ical.text": "Valitettavasti sovelluksen sisÃ¤isillÃ¤ selaimilla on ongelmia kalenteritiedoston luomisessa.",
        "modal.clipboard.text": "Olemme automaattisesti kopioineet maagisen URL-osoitteen leikepÃ¶ydÃ¤llesi.",
        "modal.webview.ical.steps": "<ol><li><strong>Avaa toinen selain</strong> puhelimessasi., ...</li><li><strong>liitÃ¤</strong> leikepÃ¶ydÃ¤n sisÃ¤ltÃ¶ ja lÃ¤hde.</li></ol>",
        ...
        "modal.crios.ical.steps": "<ol><li><strong>Avaa Safari</strong>, ...</li><li><strong>liitÃ¤</strong> leikepÃ¶ydÃ¤n sisÃ¤ltÃ¶ ja lÃ¤hde.</li></ol>",
        "modal.multidate.h": "TÃ¤mÃ¤ on tapahtumasarja",
        "modal.multidate.text": "LisÃ¤Ã¤ yksittÃ¤iset osat yksi kerrallaan:",
        Event: "Tapahtuma",
        "Cancelled Date": "TÃ¤mÃ¤ pÃ¤ivÃ¤mÃ¤Ã¤rÃ¤ peruttiin.",
        "Delete from Calendar": "PÃ¤ivitÃ¤ kalenterisi!",
        "modal.subscribe.yahoo.h": "LisÃ¤Ã¤ kalenteri Yahoo",
        "modal.subscribe.yahoo.text": '<ol><li>Avaa Yahoo-kalenteri.</li><li>Napsauta "Toiminnot"-vÃ¤lilehteÃ¤.</li><li>Valitse "Seuraa muiden kalentereita".</li><li>Valitse nimi ja liitÃ¤ URL-osoite leikepÃ¶ydÃ¤ltÃ¤si URL-kenttÃ¤Ã¤n.</li></ol>',
        Cancel: "Peruuta"
    },
    sv: {
        "Add to Calendar": "LÃ¤gg till i kalender",
        "iCal File": "iCal-fil",
        Close: "StÃ¤ng",
        "Close Selection": "StÃ¤ng urvalet",
        "Click me": "Klicka pÃ¥ mig",
        "modal.webview.ical.h": "Ã–ppna din webblÃ¤sare",
        "modal.webview.ical.text": "TyvÃ¤rr har webblÃ¤sare i appen problem med hur vi genererar kalenderfilen.",
        "modal.clipboard.text": "Vi har automatiskt kopierat en magisk URL till ditt klippblock.",
        "modal.webview.ical.steps": "<ol><li><strong>Ã–ppna en annan webblÃ¤sare</strong> pÃ¥ telefonen, ...</li><li><strong>InsÃ¤tt</strong> innehÃ¥llet i klippbordet och kÃ¶r.</li></ol>",
        "modal.crios.ical.h": "Ã–ppna Safari",
        "modal.crios.ical.text": "TyvÃ¤rr har Chrome pÃ¥ iOS problem med hur vi genererar kalenderfilen.",
        "modal.crios.ical.steps": "<ol><li><strong>Ã–ppna Safari</strong>, ...</li><li><strong>InsÃ¤tt</strong> innehÃ¥llet i klippbordet och kÃ¶r.</li></ol>",
        "modal.multidate.h": "Detta Ã¤r en evenemangsserie",
        "modal.multidate.text": "LÃ¤gg till de enskilda delarna en efter en:",
        Event: "Evenemang",
        "Cancelled Date": "Detta datum har stÃ¤llts in.",
        "Delete from Calendar": "Uppdatera din kalender!",
        "modal.subscribe.yahoo.h": "LÃ¤gg till kalender i Yahoo",
        "modal.subscribe.yahoo.text": '<ol><li>Ã–ppna Yahoo-kalendern.</li><li>Klicka pÃ¥ fliken "Ã…tgÃ¤rder".</li><li>VÃ¤lj "FÃ¶lj andra kalendrar".</li><li>VÃ¤lj ett namn och klistra in URL:en frÃ¥n klippbordet i URL-fÃ¤ltet.</li></ol>',
        Cancel: "Avbryt"
    },
    cs: {
        "Add to Calendar": "PÅ™idat do kalendÃ¡Å™e",
        "iCal File": "Soubor iCal",
        Close: "ZavÅ™Ã­t",
        "Close Selection": "ZavÅ™Ã­t vÃ½bÄ›r",
        "Click me": "KliknÄ›te na mÄ›",
        "modal.webview.ical.h": "OtevÅ™ete prohlÃ­Å¾eÄ",
        "modal.webview.ical.text": "ProhlÃ­Å¾eÄe v aplikacÃ­ch majÃ­ bohuÅ¾el problÃ©my se zpÅ¯sobem generovÃ¡nÃ­ souboru kalendÃ¡Å™e.",
        "modal.clipboard.text": "Do schrÃ¡nky jsme automaticky zkopÃ­rovali kouzelnou adresu URL.",
        "modal.webview.ical.steps": "<ol><li><strong>OtevÅ™enÃ­ jinÃ©ho prohlÃ­Å¾eÄe</strong> v telefonu, ...</li><li><strong>VloÅ¾te</strong> obsah schrÃ¡nky a pÅ™ejdÄ›te.</li></ol>",
        "modal.crios.ical.h": "OtevÅ™Ã­t Safari",
        "modal.crios.ical.text": "Chrome v systÃ©mu iOS mÃ¡ bohuÅ¾el problÃ©my se zpÅ¯sobem generovÃ¡nÃ­ souboru kalendÃ¡Å™e.",
        "modal.crios.ical.steps": "<ol><li><strong>OtevÅ™Ã­t Safari</strong>, ...</li><li><strong>VloÅ¾te</strong> obsah schrÃ¡nky a pÅ™ejdÄ›te.</li></ol>",
        "modal.multidate.h": "JednÃ¡ se o sÃ©rii udÃ¡lostÃ­",
        "modal.multidate.text": "PÅ™idÃ¡vejte jednotlivÃ© dÃ­ly jeden po druhÃ©m:",
        Event: "UdÃ¡lost",
        "Cancelled Date": "Toto datum bylo zruÅ¡eno.",
        "Delete from Calendar": "Aktualizujte svÅ¯j kalendÃ¡Å™!",
        "modal.subscribe.yahoo.h": "PÅ™idat kalendÃ¡Å™ do Yahoo",
        "modal.subscribe.yahoo.text": '<ol><li>OtevÅ™ete kalendÃ¡Å™ Yahoo.</li><li>KliknÄ›te na kartu "Akce".</li><li>Vyberte moÅ¾nost "Sledovat dalÅ¡Ã­ kalendÃ¡Å™e".</li><li>Vyberte nÃ¡zev a vloÅ¾te adresu URL ze schrÃ¡nky do pole URL.</li></ol>',
        Cancel: "Storno"
    },
    ja: {
        "Add to Calendar": "ã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ã«è¿½åŠ ",
        "iCal File": "iCalãƒ•ã‚¡ã‚¤ãƒ«",
        Close: "é–‰ã˜ã‚‹",
        "Close Selection": "ã‚¯ãƒ­ãƒ¼ã‚ºé¸æŠž",
        "Click me": "ã‚¯ãƒªãƒƒã‚¯ã—ã¦ãã ã•ã„",
        "modal.webview.ical.h": "ãƒ–ãƒ©ã‚¦ã‚¶ã‚’èµ·å‹•ã™ã‚‹",
        "modal.webview.ical.text": "æ®‹å¿µãªãŒã‚‰ã€ã‚¢ãƒ—ãƒªå†…ãƒ–ãƒ©ã‚¦ã‚¶ã¯ã€ã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ãƒ•ã‚¡ã‚¤ãƒ«ã®ç”Ÿæˆæ–¹æ³•ã«å•é¡ŒãŒã‚ã‚Šã¾ã™ã€‚",
        "modal.clipboard.text": "é­”æ³•ã®URLã‚’è‡ªå‹•çš„ã«ã‚¯ãƒªãƒƒãƒ—ãƒœãƒ¼ãƒ‰ã«ã‚³ãƒ”ãƒ¼ã—ã¦ã„ã¾ã™ã€‚",
        "modal.webview.ical.steps": "<ol><li>ã‚¹ãƒžãƒ¼ãƒˆãƒ•ã‚©ãƒ³ã§åˆ¥ã®ãƒ–ãƒ©ã‚¦ã‚¶ã‚’èµ·å‹•ã™ã‚‹, ...</li><li>ã‚¯ãƒªãƒƒãƒ—ãƒœãƒ¼ãƒ‰ã®å†…å®¹ã‚’è²¼ã‚Šä»˜ã‘ã¦è¡Œãã€‚</li></ol>",
        "modal.crios.ical.h": "ã‚ªãƒ¼ãƒ—ãƒ³Safari",
        "modal.crios.ical.text": "æ®‹å¿µãªãŒã‚‰ã€iOSç‰ˆChromeã§ã¯ã€ã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ãƒ•ã‚¡ã‚¤ãƒ«ã®ç”Ÿæˆæ–¹æ³•ã«å•é¡ŒãŒã‚ã‚Šã¾ã™ã€‚",
        "modal.crios.ical.steps": "<ol><li><strong>ã‚ªãƒ¼ãƒ—ãƒ³Safari</strong>, ...</li><li>ã‚¯ãƒªãƒƒãƒ—ãƒœãƒ¼ãƒ‰ã®å†…å®¹ã‚’è²¼ã‚Šä»˜ã‘ã¦è¡Œãã€‚</li></ol>",
        "modal.multidate.h": "ã‚¤ãƒ™ãƒ³ãƒˆã‚·ãƒªãƒ¼ã‚ºã§ã™",
        "modal.multidate.text": "å€‹ã€…ã®ãƒ‘ãƒ¼ãƒ„ã‚’ä¸€ã¤ãšã¤è¿½åŠ ã—ã¦ã„ã:",
        Event: "ã‚¤ãƒ™ãƒ³ãƒˆ",
        "Cancelled Date": "ã“ã®æ—¥ã¯ã‚­ãƒ£ãƒ³ã‚»ãƒ«ã«ãªã‚Šã¾ã—ãŸã€‚",
        "Delete from Calendar": "ã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ã‚’æ›´æ–°ã™ã‚‹!",
        "modal.subscribe.yahoo.h": "Yahooã«ã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ã‚’è¿½åŠ ã™ã‚‹",
        "modal.subscribe.yahoo.text": "<ol><li>Yahooã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ã‚’é–‹ãã€‚</li><li>[å®Ÿè¡Œ] ã‚¿ãƒ–ã‚’ã‚¯ãƒªãƒƒã‚¯ã—ã¾ã™ã€‚</li><li>[ãã®ä»–ã®ã‚«ãƒ¬ãƒ³ãƒ€ãƒ¼ã®ãƒ•ã‚©ãƒ­ãƒ¼] ã‚’é¸æŠžã—ã¾ã™ã€‚</li><li>åå‰ã‚’æ±ºã‚ã¦ã€ã‚¯ãƒªãƒƒãƒ—ãƒœãƒ¼ãƒ‰ã«ã‚ã‚‹URLã‚’URLæ¬„ã«è²¼ã‚Šä»˜ã‘ã¾ã™ã€‚</li></ol>",
        Cancel: "ã‚­ãƒ£ãƒ³ã‚»ãƒ«"
    },
    it: {
        ...
        "modal.multidate.h": "Questa Ã¨ una serie di eventi",
        "modal.multidate.text": "Aggiungere le singole parti una per una:",
        Event: "Evento",
        "Cancelled Date": "La data Ã¨ stata annullata.",
    ...
    ko: {
        "Add to Calendar": "ìº˜ë¦°ë”ì— ì¶”ê°€",
        "iCal File": "iCal íŒŒì¼",
        Close: "ë‹«ë‹¤",
        "Close Selection": "ì„ íƒ ë‹«ê¸°",
        "Click me": "í´ë¦­ í•´ì£¼ì„¸ìš”",
        "modal.webview.ical.h": "ë¸Œë¼ìš°ì € ì—´ê¸°",
        "modal.webview.ical.text": "ë¶ˆí–‰ížˆë„ ì¸ì•± ë¸Œë¼ìš°ì €ëŠ” ìº˜ë¦°ë” íŒŒì¼ì„ ìƒì„±í•˜ëŠ” ë°©ì‹ì— ë¬¸ì œê°€ ìžˆìŠµë‹ˆë‹¤.",
        "modal.clipboard.text": "ë§¤ì§ URLì„ í´ë¦½ë³´ë“œì— ìžë™ìœ¼ë¡œ ë³µì‚¬í–ˆìŠµë‹ˆë‹¤.",
        "modal.webview.ical.steps": "<ol><li>íœ´ëŒ€ì „í™”ì—ì„œ ë‹¤ë¥¸ ë¸Œë¼ìš°ì € ì—´ê¸°, ...</li><li>í´ë¦½ë³´ë“œ ë‚´ìš©ì„ ë¶™ì—¬ë„£ê³  ì´ë™í•©ë‹ˆë‹¤.</li></ol>",
        "modal.crios.ical.h": "Safari ì—´ê¸°",
        "modal.crios.ical.text": "ë¶ˆí–‰ížˆë„ iOSì˜ Chromeì€ ìº˜ë¦°ë” íŒŒì¼ì„ ìƒì„±í•˜ëŠ” ë°©ì‹ì— ë¬¸ì œê°€ ìžˆìŠµë‹ˆë‹¤.",
        "modal.crios.ical.steps": "<ol><li><strong>Safari ì—´ê¸°</strong>, ...</li><li>í´ë¦½ë³´ë“œ ë‚´ìš©ì„ ë¶™ì—¬ë„£ê³  ì´ë™í•©ë‹ˆë‹¤.</li></ol>",
        "modal.multidate.h": "ì´ë²¤íŠ¸ ì‹œë¦¬ì¦ˆìž…ë‹ˆë‹¤",
        "modal.multidate.text": "ê°œë³„ ë¶€í’ˆì„ í•˜ë‚˜ì”© ì¶”ê°€:",
        Event: "ì´ë²¤íŠ¸",
        "Cancelled Date": "ì´ ë‚ ì§œëŠ” ì·¨ì†Œë˜ì—ˆìŠµë‹ˆë‹¤.",
        "Delete from Calendar": "ìº˜ë¦°ë”ë¥¼ ì—…ë°ì´íŠ¸í•˜ì„¸ìš”!",
        "modal.subscribe.yahoo.h": "Yahooì— ìº˜ë¦°ë” ì¶”ê°€",
        "modal.subscribe.yahoo.text": '<ol><li>Yahoo ìº˜ë¦°ë”ë¥¼ ì—½ë‹ˆë‹¤.</li><li>"ë™ìž‘" íƒ­ì„ í´ë¦­í•©ë‹ˆë‹¤.</li><li>"ë‹¤ë¥¸ ì¼ì •ê´€ë¦¬ íŒ”ë¡œìš°"ë¥¼ ì„ íƒí•©ë‹ˆë‹¤.</li><li>ì´ë¦„ì„ ì„ íƒí•˜ê³  í´ë¦½ë³´ë“œì˜ URLì„ URL í•„ë“œì— ë¶™ì—¬ë„£ìŠµë‹ˆë‹¤.</li></ol>',
        Cancel: "ì·¨ì†Œ"
    },
    vi: {
        ...
        "iCal File": "Tá»‡p iCal",
        Close: "ÄÃ³ng",
        "Close Selection": "ÄÃ³ng lá»±a chá»n",
        "Click me": "Nháº¥p vÃ o Ä‘Ã¢y",
        "modal.webview.ical.h": "Má»Ÿ trÃ¬nh duyá»‡t cá»§a báº¡n",
        "modal.webview.ical.text": "Ráº¥t tiáº¿c, cÃ¡c trÃ¬nh duyá»‡t trong á»©ng dá»¥ng gáº·p sá»± cá»‘ vá»›i cÃ¡ch chÃºng tÃ´i táº¡o tá»‡p lá»‹ch.",
        "modal.clipboard.text": "ChÃºng tÃ´i Ä‘Ã£ tá»± Ä‘á»™ng sao chÃ©p má»™t URL ma thuáº­t vÃ o khay nhá»› táº¡m cá»§a báº¡n.",
        "modal.webview.ical.steps": "<ol><li><strong> Má»Ÿ trÃ¬nh duyá»‡t khÃ¡c </strong> trÃªn Ä‘iá»‡n thoáº¡i cá»§a báº¡n, ...</li><li><strong> DÃ¡n </strong> ná»™i dung khay nhá»› táº¡m vÃ  báº¯t Ä‘áº§u.</li></ol>",
        "modal.crios.ical.h": "Má»Ÿ Safari",
        "modal.crios.ical.text": "Ráº¥t tiáº¿c, Chrome trÃªn iOS gáº·p sá»± cá»‘ vá»›i cÃ¡ch chÃºng tÃ´i táº¡o tá»‡p lá»‹ch.",
        "modal.crios.ical.steps": "<ol><li><strong>Má»Ÿ Safari</strong>, ...</li><li><strong> DÃ¡n </strong> ná»™i dung khay nhá»› táº¡m vÃ  báº¯t Ä‘áº§u.</li></ol>",
        "modal.multidate.h": "ÄÃ¢y lÃ  má»™t chuá»—i sá»± kiá»‡n",
        "modal.multidate.text": "ThÃªm tá»«ng pháº§n riÃªng láº» má»™t:",
        Event: "Biáº¿n cá»‘",
        "Cancelled Date": "NgÃ y nÃ y Ä‘Ã£ bá»‹ há»§y.",
        "Delete from Calendar": "Cáº­p nháº­t lá»‹ch cá»§a báº¡n!",
        "modal.subscribe.yahoo.h": "ThÃªm lá»‹ch vÃ o Yahoo",
        "modal.subscribe.yahoo.text": '<ol><li>Má»Ÿ Lá»‹ch Yahoo.</li><li>Nháº¥p vÃ o tab "HÃ nh Ä‘á»™ng".</li><li>Chá»n "Theo dÃµi cÃ¡c Lá»‹ch khÃ¡c".</li><li>Chá»n tÃªn vÃ  dÃ¡n URL tá»« khay nhá»› táº¡m cá»§a báº¡n vÃ o trÆ°á»ng URL.</li></ol>',
        Cancel: "Há»§y bá»"
    }
};
...
function atcb_init() {
    if (atcbInitialInit || atcb_set_global_event_listener(), atcb_init_log_msg(), isBrowser()) {
        ...
        if (0 < o.length) {
            ...
            for (let e = 0; e < o.length; e++) o[parseInt(e)].classList.contains("atcb-initialized") || 0 != (t = atcb_get_pro_data(atcb_patch_config(function () {
                try {
            ...
            }()))).length && atcb_check_required(t) && (null != (t = atcb_decorate_data(t)).identifier && "" != t.identifier || (t.identifier = "atcb-btn-" + (e + n.length + 1)), atcb_validate(t) && (atcb_generate_button(o[parseInt(e)], t), atcb_update_state_management(t), a.push(t.identifier)))
        }
        return a
    }
...
function atcb_action(e, a, t = !0) {
    if (atcbInitialInit || atcb_set_global_event_listener(), atcb_init_log_msg(), !atcb_check_required(e = atcb_get_pro_data(e = atcb_secure_content(e)))) throw new Error("Add to Calendar Button generation failed: required data missing; see console logs");
    if (e = atcb_decorate_data(e), a ? (null != a.id && "" != a.id ? e.identifier = a.id : null != e.identifier && "" != e.identifier ? a.id = e.identifier : e.identifier = "atcb-btn-custom", "dropdown" == e.listStyle && (e.listStyle = "overlay")) : (e.identifier = "atcb-btn-custom", e.listStyle = "modal", e.trigger = "click"), atcb_validate(e)) return atcb_update_state_management(e), atcb_toggle("open", e, a, t), console.log('Add to Calendar Button "' + e.identifier + '" triggered'), [e.identifier];
...
function atcb_destroy(e) {
    ...
    return null != atcbStates["" + e] && a ? (delete atcbStates["" + e], (a.parentElement.parentElement.classList.contains("atcb-initialized") ? a.parentElement.parentElement : a).remove(), console.log('Add to Calendar Button "' + e + '" destroyed'), !0) : (console.error("Add to Calendar Button could not be destroyed! ID unknown."), !1)
}
...
function atcb_set_global_event_listener() {
    isBrowser() && (document.addEventListener("keyup", function (e) {
        ...
        if (document.querySelector(".atcb-list") && ("ArrowDown" === a.key || "ArrowUp" === a.key || "Tab" === a.key)) {
            ...
            if (t.classList.contains("atcb-list-item")) "ArrowDown" === a.key && t.dataset.optionNumber < n ? (a.preventDefault(), e = parseInt(t.dataset.optionNumber) + 1) : "ArrowUp" === a.key && 1 <= t.dataset.optionNumber && (a.preventDefault(), e = parseInt(t.dataset.optionNumber) - 1), 0 < e && document.querySelector('.atcb-list-item[data-option-number="' + e + '"]').focus();
            else switch (a.preventDefault(), a.key) {
                case "ArrowDown":
        ...
        var e, a = document.getElementById("atcb-bgoverlay"),
...
! function (e, t) {
    ...
    const t = e => {
        ...
        ce = (e, t) => {
            const o = E(),
                i = P();
            t.showConfirmButton || t.showDenyButton || t.showCancelButton ? W(o) : z(o), D(o, t, "actions"),
                function (e, t, o) {
                    const i = k(),
                        s = B(),
                        r = x();
                    ue(i, "confirm", o), ue(s, "deny", o), ue(r, "cancel", o),
                        function (e, t, o, i) {
    ...
    const Ce = (t, o) => {
            const i = w();
            D(i, o, "htmlContainer"), o.html ? (se(o.html, i), W(i, "block")) : o.text ? (i.textContent = o.text, W(i, "block")) : z(i), ((t, o) => {
                const i = f(),
        ...
        Ee = (e, t) => {
            e.className = `${n.popup} ${Z(e)?t.showClass.popup:""}`, t.toast ? (F([document.documentElement, document.body], n["toast-shown"]), F(e, n.toast)) : F(e, n.modal), D(e, t, "popup"), "string" == typeof t.customClass && F(e, t.customClass), t.icon && F(e, n[`icon-${t.icon}`])
        },
        $e = e => {
    ...
    const je = () => k() && k().click(),
        ...
        Ve = (t, n, o) => {
            const i = e.innerParams.get(t);
            i && (n.isComposing || 229 === n.keyCode || (i.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key ? Ne(t, n, i) : "Tab" === n.key ? Fe(n, i) : [...De, ...qe].includes(n.key) ? Re(n.key) : "Escape" === n.key && Ue(n, i, o)))
        },
        Ne = (e, t, n) => {
    ...
    const wn = (t, n, o) => new Promise(((i, s) => {
            ...
            _e.swalPromiseResolve.set(t, i), _e.swalPromiseReject.set(t, s), n.confirmButton.onclick = () => {
                ...
                He(t), n.toast || (t.keydownHandler = t => Ve(e, t, o), t.keydownTarget = n.keydownListenerCapture ? window : f(), t.keydownListenerCapture = n.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {
        ...
        An = (e, t, n) => {
            ...
            }), t.timer), t.timerProgressBar && (W(o), D(o, t, "timerProgressBar"), setTimeout((() => {
    ...
    })), yn.DismissReason = Me, yn.version = "11.6.14";
    const xn = yn;

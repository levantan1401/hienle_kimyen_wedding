...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function (a) {
    ...
    if (!a.fn.tooltip) throw new Error("Popover%20requires%20tooltip.js");
    ...
    var h = {
        ...
        re = {
            ...
            getPathValues: function () {
                var e = s.location.pathname.slice(1).split("http://themegeniuslab.com/").filter(function (e) {
                        return "" !== e
                    }),
                    t = e.length;
                return {
